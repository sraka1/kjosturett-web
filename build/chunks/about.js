...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__About_scss__ = __webpack_require__(182);
...
var _ref = _jsx('p', {}, void 0, 'Voliprav.si je neodvisna informativna spletna stran, ki sku\u0161a informirati volivce v zvezi dr\u017Eavnozborskimi volitvami leta 2022. Vse informacije na spletni strani so pridobljene od politi\u010Dnih strank samih in so predstavljene nespremenjene. Projekt prostovoljno podpira skupina prostovoljcev, vsa koda pa je dostopna na', ' ', _jsx('a', {
  href: 'https://github.com/sraka1/voliprav-web',
  target: '_blank'
}, void 0, 'GitHubu'), ', temelji pa na podobnem strani (oz. je "fork"), ki je bila ustvarjen v Islandiji in tam po\u017Eela izjemen uspeh (doseg tretjine celotnega volilnega telesa). Upamo, da vam bo stran pomagala, dragi volivec ali volivka, opraviti informirano odlo\u010Ditev na voli\u0161\u010Du.');
...
var _ref5 = _jsx('p', {}, void 0, 'Na nas se lahko obrnete preko e-po\u0161te na naslovu', ' ', _jsx('a', {
  href: 'mailto:voliprav@voliprav.si'
}, void 0, 'voliprav@voliprav.si'), '.');

class About extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
  render() {
    return _jsx('div', {
      className: __WEBPACK_IMPORTED_MODULE_2__About_scss___default.a.root
    }, void 0, _ref, _ref2, _jsx('div', {
      className: __WEBPACK_IMPORTED_MODULE_2__About_scss___default.a.we
    }, void 0, _jsx('div', {
    ...
    }, void 0, 'Jakob Murko'))), _ref3, _jsx('div', {
      className: __WEBPACK_IMPORTED_MODULE_2__About_scss___default.a.contributors
    }, void 0, _jsx('div', {
      className: __WEBPACK_IMPORTED_MODULE_2__About_scss___default.a.person
    }, void 0, _jsx('img', {
      className: __WEBPACK_IMPORTED_MODULE_2__About_scss___default.a.img,
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles___default()(__WEBPACK_IMPORTED_MODULE_2__About_scss___default.a)(About));
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    if (false) {
      ...
      module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--1-rules-2!../../../node_modules/postcss-loader/lib/index.js??ref--1-rules-3!../../../node_modules/sass-loader/dist/cjs.js!./About.scss", function() {
        content = require("!!../../../node_modules/css-loader/index.js??ref--1-rules-2!../../../node_modules/postcss-loader/lib/index.js??ref--1-rules-3!../../../node_modules/sass-loader/dist/cjs.js!./About.scss");
...
// module
exports.push([module.i, "._3ILsw{color:#585858;margin-left:auto;margin-right:auto;padding:calc(-22.85714px + 4.57143vw) 1em 3.66667vw;max-width:768px;font-size:calc(10.14286px + .57143vw)}@media(min-width:1200px){._3ILsw{padding-bottom:44px}}@media(max-width:499px){._3ILsw{padding-top:0}}@media(min-width:1200px){._3ILsw{padding-top:32px}}@media(max-width:499px){._3ILsw{font-size:13px}}@media(min-width:1200px){._3ILsw{font-size:17px}}._3ILsw *+*{margin-top:1em}._3ILsw a{color:inherit;text-decoration:none}._3nAEh{text-align:center}@media(min-width:600px){._3nAEh{display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-pack:distribute;justify-content:space-around}}._3nAEh ._18YlB{margin-bottom:2em;margin-top:3em}._3nAEh ._18YlB a{display:inline-block;background-image:-webkit-gradient(linear,left bottom,left top,from(#555),to(#555));background-image:-webkit-linear-gradient(bottom,#555,#555);background-image:-o-linear-gradient(bottom,#555,#555);background-image:linear-gradient(0deg,#555,#555);background-position:0 calc(1em + 4px);background-repeat:no-repeat;background-size:100% 1px}@media(min-width:600px){._3nAEh ._18YlB{margin-top:2em}}._3nAEh ._3N4dj{font-size:1.2em;font-weight:700;font-family:Lora,serif;margin-top:.5em}._3nAEh ._1ryfh{margin-top:0}._3nAEh ._2UKAl{border-radius:50%;max-width:250px;width:100%}.b9QLG{display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;text-align:center}@media(min-width:600px){.b9QLG{display:-webkit-box;display:-ms-flexbox;display:flex;-ms-flex-pack:distribute;justify-content:space-around}}.b9QLG ._18YlB{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-flex:1;-ms-flex:1 1;flex:1 1;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;margin-bottom:2em;margin-top:3em}.b9QLG ._18YlB a{display:inline-block;background-image:-webkit-gradient(linear,left bottom,left top,from(#555),to(#555));background-image:-webkit-linear-gradient(bottom,#555,#555);background-image:-o-linear-gradient(bottom,#555,#555);background-image:linear-gradient(0deg,#555,#555);background-position:0 calc(1em + 4px);background-repeat:no-repeat;background-size:100% 1px}@media(min-width:600px){.b9QLG ._18YlB{margin-top:2em}}.b9QLG ._3N4dj{font-size:.8em;font-weight:700;font-family:Lora,serif;margin-top:.5em}.b9QLG ._2UKAl{border-radius:50%;height:70px;width:70px;-o-object-fit:cover;object-fit:cover}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__About__ = __webpack_require__(181);
...
var _ref = _jsx(__WEBPACK_IMPORTED_MODULE_2__components_Layout__["a" /* default */], {
  page: 'o-nas',
  title: 'O nas'
}, void 0, _jsx(__WEBPACK_IMPORTED_MODULE_1__About__["a" /* default */], {}));
