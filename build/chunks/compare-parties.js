  ...
  render() {
    ...
    return _jsx('div', {
      ...
      return _jsx('div', {
        ...
        className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()(__WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.dot, !distance !== 0 && __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a[`dot${distanceValueMap[Math.round(distance * 100) / 100]}`])
      }), question), distance === 0 && filterParties.length === 2 && _jsx('div', {}, void 0, `Obe stranki sta označili odgovor ${__WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json___default.a.textMap[replies[0]].toLowerCase()}${['3', '6'].includes(replies[0]) ? '' : ''} pri tej izjavi.`), distance === 0 && filterParties.length > 2 && _jsx('div', {}, void 0, `Vse stranke so označile odgovor ${__WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json___default.a.textMap[replies[0]].toLowerCase()}${['3', '6'].includes(replies[0]) ? '' : ''} pri tej izjavi.`), distance > 0 && _jsx('div', {}, void 0, filterParties.map(party => _jsx('div', {}, party.name, _jsx('p', {}, void 0, _jsx('span', {}, void 0, party.name), ' ', `${['Píratar', 'Vinstri Græn'].includes(party.name) ? 'eru' : 'er'} `, _jsx('b', {}, void 0, __WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json___default.a.textMap[party.reply[id - 1]].toLowerCase()))))));
    })));
  }
}
