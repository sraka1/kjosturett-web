...
/* harmony export (immutable) */ __webpack_exports__["a"] = getResultsByScore;
...
function getResultsByScore(answers, dataset) {
  ...
  return dataset.map(data => _extends({}, data, {
...
module.exports = [{"letter":"DeSUS","url":"desus","name":"Demokratska Stranka Upokojencev Slovenije","nameDeflected":"DeSUS","website":"https://desus.si/","leader":"Ljubo Jasnič","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"DD","url":"dobra-drzava","name":"Dobra Država","nameDeflected":"Dobra Država","website":"https://www.dobradrzava.si/","leader":"Smiljan Mekicar","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542356","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"GS","url":"gibanje-svoboda","name":"Gibanje Svoboda","nameDeflected":"Gibanje Svoboda","website":"https://gibanjesvoboda.si/","leader":"Robert Golob","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#00569D"},{"letter":"K","url":"konkretno","name":"Konkretno","nameDeflected":"stranke Konkretno","website":"https://konkretno.si","leader":"Zdravko Počivalšek","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"L","url":"levica","name":"Levica","nameDeflected":"Levice","website":"https://www.levica.si","leader":"Luka Mesec","leaderTitle":"Koordinator","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"LMŠ","url":"lms","name":"Lista Marjana Šarca","nameDeflected":"Liste Marjana Šarca","website":"https://www.strankalms.si","leader":"Marjan Šarec","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"ND","url":"nasa-dezela","name":"Naša Dežela","nameDeflected":"stranke Naša Dežela","website":"https://nasadezela.si/","leader":"Aleksandra Pivec","leaderTitle":"Predsednica","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"NSi","url":"nsi","name":"Nova Slovenija","nameDeflected":"stranke Nova Slovenija","website":"https://nsi.si","leader":"Matej Tonin","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"P","url":"piratska-stranka","name":"Piratska Stranka","nameDeflected":"Piratske Stranke","website":"https://piratskastranka.si","leader":"Boštjan Tavčar","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#000000"},{"letter":"PS","url":"povezimo-slovenijo","name":"Povežimo Slovenijo","nameDeflected":"gibanja Povežimo Slovenijo","website":"https://povezimoslovenijo.si/","leader":"Nada Pavšer","leaderTitle":"Koordinatorka","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"SAB","url":"sab","name":"Stranka Alenke Bratušek","nameDeflected":"Stranke Alenke Bratušek","website":"https://sab.si","leader":"Alenka Bratušek","leaderTitle":"Predsednica","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"SD","url":"sd","name":"Socialni Demokrati","nameDeflected":"Socialnih Demokratov","website":"https://socialnidemokrati.si/","leader":"Tanja Fajon","leaderTitle":"Predsednica","reply":"5544552214144443445225454132521442542356","color":"#E3000F","textColor":"#FFFFFF"},{"letter":"SDS","url":"sds","name":"Slovenska Demokratska Stranka","nameDeflected":"Slovenske Demokratske Stranke","website":"https://www.sds.si","leader":"Ivan Janez Janša","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"},{"letter":"SNS","url":"sns","name":"Slovenska Nacionalna Stranka","nameDeflected":"Slovenske Nacionalne Stranke","website":"http://sns.si/","leader":"Zmago Jelinčič Plemeniti","leaderTitle":"Predsednik","reply":"5544552214144443445225454132521442542355","color":"#FEE51E"},{"letter":"VESNA","url":"vesna","name":"VESNA - zelena stranka","nameDeflected":"stranke VESNA - zelene stranke","website":"https://www.vesnazelenastranka.si","leader":"Uroš Macerl in Urša Zgojznik","leaderTitle":"Sopredsednika","reply":"5544552214144443445225454132521442542355","color":"#3A36FF","textColor":"#FFFFFF"}]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Party__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Party_scss__ = __webpack_require__(105);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils__ = __webpack_require__(94);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PartyGrid__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PartyGrid_scss__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__process_replies__ = __webpack_require__(101);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CompareParties__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Layout__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_poll_questions_json__ = __webpack_require__(96);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json__);
var _jsx = function () { var REACT_ELEMENT_TYPE = typeof Symbol === "function" && Symbol.for && Symbol.for("react.element") || 0xeac7; return function createRawReactElement(type, props, key, children) { var defaultProps = type && type.defaultProps; var childrenLength = arguments.length - 3; if (!props && childrenLength !== 0) { props = {}; } if (props && defaultProps) { for (var propName in defaultProps) { if (props[propName] === void 0) { props[propName] = defaultProps[propName]; } } } else if (!props) { props = defaultProps || {}; } if (childrenLength === 1) { props.children = children; } else if (childrenLength > 1) { var childArray = Array(childrenLength); for (var i = 0; i < childrenLength; i++) { childArray[i] = arguments[i + 3]; } props.children = childArray; } return { $$typeof: REACT_ELEMENT_TYPE, type: type, key: key === undefined ? null : '' + key, ref: null, props: props, _owner: null }; }; }();
...
__WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json___default.a.sort(function (a, b) {
...
/* harmony default export */ __webpack_exports__["default"] = (({ url, params }) => {
  let { letters } = params;
  ...
  //Begin calculations
  let filterParties = letters.map(letter => __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json___default.a.filter(party => party.letter === letter)[0]);
  ...
  const maxReplies = [];
  const replyDistance = [];
  for (let i = 0; i <= __WEBPACK_IMPORTED_MODULE_4__data_poll_questions_json___default.a.length - 1; i++) {
    let max;
    let min;
  ...
  const score = Object(__WEBPACK_IMPORTED_MODULE_1__process_replies__["b" /* match */])(minReplies, maxReplies);
  const percentage = `${score.toFixed(0)}%`;

  let title = 'Primerjaj - Voli prav';
  let description = 'Tukaj lahko primerjate stališča različnih političnih strank. Katera koalicija je najbolj verjetna? Poigrajte s različnimi kombinacijami.';

  if (letters.length > 0) {
    const currentParties = __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json___default.a.filter(party => letters.includes(party.letter));

    if (letters.length === 1) {
      title = `Berðu ${partyDeflectionsB[currentParties[0].letter]} saman við aðra flokka`;
      description = `Hversu samstíga eru ${currentParties[0].name} og aðrir flokkar? Þú getu skoðað málið betur hérna.`;
    } else if (letters.length === 2) {
      title = `${currentParties.map(p => p.name).join(' og ')} eru ${percentage} samstíga`;
      description = `Skoðaðu málið betur ásamt fleiri möguleikum á kjósturétt.is.`;
    } else {
      let stjorn = currentParties.map(p => partyDeflections[p.letter]).join(', ');
  ...
  return {
    ...
    description,
    path: url,
    component: _jsx(__WEBPACK_IMPORTED_MODULE_3__components_Layout__["a" /* default */], {
      page: 'compare-parties',
      title: 'Primerjaj'
    }, void 0, _jsx(__WEBPACK_IMPORTED_MODULE_2__CompareParties__["a" /* default */], {
      parties: __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json___default.a,
      questions: __WEBPACK_IMPORTED_MODULE_4__data_poll_questions_json___default.a,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_classnames__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_scss__ = __webpack_require__(205);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__history__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json__ = __webpack_require__(97);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Link__ = __webpack_require__(75);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Party__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_PartyGrid__ = __webpack_require__(107);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
class CompareParties extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
  constructor(...args) {
    var _temp;
  ...
  render() {
    ...
    if (this.state.isEditing || filterParties.length < 2) {
      return _jsx('div', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.root
      }, void 0, _jsx('h1', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.heading
      }, void 0, 'Izberite stranke, ki jih \u017Eelite primerjati.'), _jsx('div', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.chooseContainer
      }, void 0, _jsx(__WEBPACK_IMPORTED_MODULE_8__components_PartyGrid__["a" /* default */], {}, void 0, parties.map(party => {
        const isSelected = this.state.selected.includes(party.letter);
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_Party__["a" /* default */], _extends({}, party, {
          key: party.letter,
      ...
      }))), this.state.selected.length === 1 && _jsx('p', {
        style: { textAlign: 'center', marginTop: '20px' }
      }, void 0, 'Veldu amk. einn flokk til vi\xF0b\xF3tar.'), this.state.selected.length > 1 && _jsx('div', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.buttonContainer
      }, void 0, _jsx('button', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.edit,
        onClick: () => {
          this.setState({ selected: [] });
          __WEBPACK_IMPORTED_MODULE_4__history__["a" /* default */].replace(`/stranke/primerjaj/`);
        }
      }, void 0, 'Po\u010Disti izbiro'), _jsx('button', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.edit,
        onClick: () => {
          this.setState({ isEditing: false });
          __WEBPACK_IMPORTED_MODULE_4__history__["a" /* default */].push(`/stranke/primerjaj/${this.state.selected.join(':')}`);
        }
      }, void 0, 'Primerjaj')));
    }
    ...
    return _jsx('div', {
      ...
      className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.heading
    }, void 0, 'Primerjava politi\u010Dnih strank'), _jsx('div', {
      className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.chooseContainer
    }, void 0, _jsx(__WEBPACK_IMPORTED_MODULE_8__components_PartyGrid__["a" /* default */], {}, void 0, filterParties.map(party => {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__components_Party__["a" /* default */], _extends({}, party, { key: party.letter }));
    }))), _jsx('button', {
      className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()(__WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.edit, __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.newSelection),
      onClick: () => this.setState({
        isEditing: true,
        selected: filterParties.map(x => x.letter)
      })
    }, void 0, 'Izberi druge stranke'), filterParties.length > 1 && filterParties.length < 3 && _jsx('h2', {
      id: 'score',
      className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.scoreContainer
    }, void 0, `Stranki imata ${score.toFixed(0)}% skladna stališča.`), filterParties.length > 2 && _jsx('h2', {
      id: 'score',
      className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.scoreContainer
    }, void 0, `Stranke imajo ${score.toFixed(0)}% skladna stališča.`), filterParties.length > 1 && _jsx('p', {
      className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.buttons
    ...
    }, void 0, 'Rezultat je izra\u010Dunan iz slede\u010Dih izjav:'), filterParties.length > 1 && _jsx('div', {
      className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.questionsContainer
    }, void 0, questions.map(question => _extends({}, question, {
      ...
      return _jsx('div', {
        className: __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.partyQuestion
      }, id, _jsx('h4', {}, void 0, _jsx('i', {
        className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()(__WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a.dot, !distance !== 0 && !questionHasUnansweredReplies && __WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a[`dot${distanceValueMap[Math.round(distance * 100) / 100]}`])
      }), question), distance === 0 && filterParties.length === 2 && !questionHasUnansweredReplies && _jsx('div', {}, void 0, `Obe stranki sta označili odgovor ${__WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json___default.a.textMap[replies[0]].toLowerCase()}${['3', '6'].includes(replies[0]) ? '' : ''} pri tej izjavi.`), distance === 0 && filterParties.length > 2 && !questionHasUnansweredReplies && _jsx('div', {}, void 0, `Vse stranke so označile odgovor ${__WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json___default.a.textMap[replies[0]].toLowerCase()}${['3', '6'].includes(replies[0]) ? '' : ''} pri tej izjavi.`), (distance > 0 || questionHasUnansweredReplies) && _jsx('div', {}, void 0, filterParties.map(party => _jsx('div', {}, party.name, _jsx('p', {}, void 0, _jsx('span', {}, void 0, party.name), ' ', `${['Socialni Demokrati'].includes(party.name) ? 'so označili' : 'je označila'} `, _jsx('b', {}, void 0, __WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json___default.a.textMap[party.reply[id - 1]].toLowerCase()))))));
    })));
  }
}

/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles___default()(__WEBPACK_IMPORTED_MODULE_3__styles_scss___default.a)(CompareParties));
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    if (false) {
      var removeCss = function() {};
      module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--1-rules-2!../../../node_modules/postcss-loader/lib/index.js??ref--1-rules-3!../../../node_modules/sass-loader/dist/cjs.js!./styles.scss", function() {
        content = require("!!../../../node_modules/css-loader/index.js??ref--1-rules-2!../../../node_modules/postcss-loader/lib/index.js??ref--1-rules-3!../../../node_modules/sass-loader/dist/cjs.js!./styles.scss");
...
// module
exports.push([module.i, "._2PkRS{margin:0 auto;padding-bottom:3.66667vw;padding-top:calc(-22.85714px + 4.57143vw);font-size:calc(10.14286px + .57143vw)}@media(min-width:1200px){._2PkRS{padding-bottom:44px}}@media(max-width:499px){._2PkRS{padding-top:0}}@media(min-width:1200px){._2PkRS{padding-top:32px}}@media(max-width:499px){._2PkRS{font-size:13px}}@media(min-width:1200px){._2PkRS{font-size:17px}}._2PkRS a{color:inherit}._2PkRS h2,._2PkRS h3,._2PkRS h4{line-height:1.2}._2PkRS h2{margin-bottom:.5em}._2PkRS h3{margin-top:2.5em}._2PkRS ._1R32U{margin:0 0 32px;margin:0 0 2rem;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-ms-flex-wrap:wrap;flex-wrap:wrap}._2PkRS ._2REPJ{background:#353535;border-radius:4px;display:table;text-decoration:none;color:#fff;border:none;font-size:13.6px;font-size:.85rem;font-weight:500;padding:.6em 1em;text-align:center}@media screen and (max-width:420px){._2PkRS ._2REPJ{width:100%;font-weight:500;padding:.6em 1em;margin-left:0!important;margin-top:12px}}._2fMbR{font-size:24px;font-size:1.5rem;padding-top:32px;padding-top:2rem;margin-bottom:16px;margin-bottom:1rem}._36N8D{-webkit-appearance:none;-moz-appearance:none;appearance:none;background:#909dab;border-radius:4px;color:#fff;cursor:pointer;font-weight:900;display:block;border:none;padding:16px 24px;padding:1rem 1.5rem;margin:32px 16px 64px;margin:2rem 1rem 4rem}.bzvO2{margin:32px auto 64px;margin:2rem auto 4rem}._1iBCV{text-align:center}._39Bye .BGhYC{margin-bottom:3em}._39Bye .BGhYC p:first-of-type{font-size:1.2em}._39Bye .BGhYC p+p{padding-top:1.4em;opacity:.7}.vCCn-+.vCCn-{margin-top:64px;margin-top:4rem}.vCCn-{position:relative;padding:3em 4em;-webkit-transition:opacity .3s ease-in-out;-o-transition:opacity .3s ease-in-out;transition:opacity .3s ease-in-out;text-align:center;overflow:hidden;margin-left:auto;margin-right:auto;max-width:550px}.vCCn- h3{font-family:Lora,serif;line-height:1.7;margin:0 -40px 2em}.vCCn- img{height:auto;position:absolute;left:1em;top:50%;-webkit-transform:translateY(-50%);-ms-transform:translateY(-50%);transform:translateY(-50%);width:20px}.vCCn- input{opacity:0;position:absolute}.vCCn- label{background-color:#f0f0f0;border-radius:4px;display:block;cursor:pointer;font-size:16px;font-size:1rem;padding:1em 1.5em;padding-left:3em;position:relative;margin-bottom:2px}.vCCn- input:checked+label{background:#333;color:#fff}.ejySG{padding-left:45px;padding-bottom:calc(5px + .83333vw);padding-top:calc(5px + 2.5vw)}@media(min-width:600px){.ejySG{padding-bottom:10px;padding-top:20px}}.ejySG:last-child{margin-bottom:32px;margin-bottom:2rem}.ejySG h4{line-height:1.5;font-weight:400;margin-bottom:.4em;position:relative}.ejySG ._3HYRg{background-color:#aaa;-webkit-box-shadow:0 0 4px 0 #aaa;box-shadow:0 0 4px 0 #aaa;border-radius:50%;display:inline-block;-webkit-box-sizing:content-box;box-sizing:content-box;border:2px solid #fff;height:13px;position:absolute;top:.3em;left:-35px;width:13px}.ejySG .v7Ahb{background-color:#7ed321;-webkit-box-shadow:0 0 4px 0 #7ed321;box-shadow:0 0 4px 0 #7ed321}.ejySG ._3jllT{background-color:#aedd32;-webkit-box-shadow:0 0 4px 0 #aedd32;box-shadow:0 0 4px 0 #aedd32}.ejySG ._3AVSn{background-color:#c0c75e;-webkit-box-shadow:0 0 4px 0 #c0c75e;box-shadow:0 0 4px 0 #c0c75e}.ejySG .G_WCz{background-color:#d39537;-webkit-box-shadow:0 0 4px 0 #d39537;box-shadow:0 0 4px 0 #d39537}.ejySG ._1RUb3{background-color:#c21716;-webkit-box-shadow:0 0 4px 0 #c21716;box-shadow:0 0 4px 0 #c21716}@media(min-width:600px){.ejySG h4{font-size:1.25rem}}._3dVPB{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-top:30px;margin-bottom:16px;margin-bottom:1rem;font-size:33.6px;font-size:2.1rem;font-weight:300}._2LWvq{margin-top:32px;margin-top:2rem}.SShbm{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:145px;margin:10px;cursor:pointer;padding-bottom:20px}.SShbm p{height:26px;font-size:13px;font-size:.8125rem;text-align:center}.SShbm div{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;height:100%}._3KPDt{width:auto;height:auto;max-width:80px;max-height:80px;margin:10px 15px}@media screen and (max-width:800px){._3KPDt{max-width:60px;max-height:60px}}@media screen and (max-width:600px){._3KPDt{max-width:50px;max-height:50px}}@media screen and (max-width:500px){._3KPDt{max-width:40px;max-height:40px;margin:5px 7.5px}}.RHjp-{background:#eaeaea}._3AEHV{text-align:center;margin-bottom:30px;margin-top:0;font-weight:400}._1R32U{margin-top:20px;-ms-flex-wrap:wrap;flex-wrap:wrap}._1R32U,._3qHIs{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}", ""]);
...
exports.locals = {
	...
	"dot3": "G_WCz",
	"dot4": "_1RUb3",
	"scoreContainer": "_3dVPB",
	"chooseContainer": "_2LWvq",
	"selectContainer": "SShbm",
	"selectLogo": "_3KPDt",
	"selected": "RHjp-",
	"heading": "_3AEHV",
	"buttonContainer": "_3qHIs"
};
...
//# sourceMappingURL=compare-parties.js.map