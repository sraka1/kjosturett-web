...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__process_replies__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CompareParties__ = __webpack_require__(217);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Layout__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__data_poll_questions_json__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json__ = __webpack_require__(103);
...
/* harmony default export */ __webpack_exports__["default"] = (({ url, params }) => {
  ...
  console.log('parties', __WEBPACK_IMPORTED_MODULE_5__data_build_replies_parties_json___default.a);
  ...
  if (letters.length > 0) {
    ...
    if (letters.length === 1) {
      title = `Primerjajte ${partyDeflectionsB[currentParties[0].letter]} z drugimi strankami`;
      description = `Kako se vaša stališča skladajo s stranko ${currentParties[0].name}?`;
    } else if (letters.length === 2) {
      title = `${currentParties.map(p => p.name).join(' in ')} sta ${percentage} skladni`;
...
function getResultsByScore(answers, dataset) {
  ...
  const data = dataset.map(data => _extends({}, data, {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_classnames__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_classnames___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_classnames__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__styles_scss__ = __webpack_require__(218);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__history__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__data_poll_answers_json__ = __webpack_require__(100);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Link__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Party__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_PartyGrid__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_react_tooltip__ = __webpack_require__(56);
...
var _ref = _jsx(__WEBPACK_IMPORTED_MODULE_9_react_tooltip___default.a
// place={'top'}
...
class CompareParties extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
  ...
  render() {
    ...
    if (this.state.isEditing || filterParties.length < 2) {
      ...
      }, void 0, _jsx(__WEBPACK_IMPORTED_MODULE_8__components_PartyGrid__["a" /* default */], {}, void 0, _ref, parties.map(party => {
      ...
      }, void 0, 'Izberite vsaj \u0161e eno stranko ali listo.'), this.state.selected.length > 1 && _jsx('div', {
    ...
    return _jsx('div', {
      ...
      href: `https://twitter.com/home?status=${encodeURIComponent('Primerjava strank na portalu Voli prav - https://voliprav.si' + url)}`,
      target: '_blank'
