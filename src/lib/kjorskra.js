...
var _a = require('kennitala'), clean = _a.clean, isPerson = _a.isPerson;
...
module.exports = function (kt) {
    return __awaiter(this, void 0, void 0, function () {
        var res, $, form, kt_cleaned, kt_formatted, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    form = {};
                    kt_cleaned = clean(kt);
                    kt_formatted = kt_cleaned.slice(0, 6) + '-' + kt_cleaned.slice(6);
                ...
                case 2:
                    res = _a.sent();
                    $ = cheerio.load(res.body);
                    response = $('#ASPxGridView1_DXDataRow0 td')
